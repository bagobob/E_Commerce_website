...
<header class="header">
    <div class="text-right">
        <a href="../product.php" class="logo">
            ...
            E-commerce </a>
        <nav class="menu">
            <a href="#"> <button type="button" class="btn btn-danger"> Identifier-vous
...
<br>
    <p class="marge3">
        <h2 class="marge3">
        <svg class="bi bi-cart-fill" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="container-fluid fond">
    <div class="row">
        ...
        <div class="col-lg-11">
            <div class="row">
                <div class="col-lg-4">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos quisquam rem provident neque omnis laudantium quasi earum ullam accusamus, ex placeat quis, suscipit dignissimos! At necessitatibus dicta cupiditate a excepturi.
                </div>
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-5">
                        ...
                        <div class="col-lg-2">
                            <h1 class="text-right"> xxxxxxx </h1>
                        </div>
                    </div>
            ...
            <div class="marge4">
                Total à payer : x.xxx.xxx <br>
            </div>
            <div class="marge4">
                <a href="#"> <button type="button" class="btn btn-danger"> Effectuer le paiement!
                        <svg class="bi bi-person-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"> </path>
                            <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"> </path>
                            <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"> </path>
