...
<header class="header">
    <div class="text-right">
        ...
        <nav class="menu">
            ...
            <a href="./front-office/command.php">Mon panier
...
<div class="container-fluid fond">
    <div class="row">
        <div class="col-lg-1 text-center marge">
            <br>
            <ul id="menu">
                <li class=""><a href="#">Trier par</a>
                    <ul>
                        <li><a href="#">Ordre Décroissant</a></li>
                        <li><a href="#">Ordre croissant</a></li>
        ...
        <div class="col-lg-11">
            <br>
            <div class="jumbotron my-auto fondimage">
                <h1 class="">Bienvenue,</h1>
                <h4 class="">vous desirez?</h4>
                <!--  <ul id="menu">
                      <li class=""><a href="#">Trier par</a>
                          <ul>
                              <li><a href="#">Ordre Décroissant</a></li>
            ...
            <div class="row marge2">
                <div class="col-lg-4 text-center">
                    ...
                    <h5>
                        Prix: 150$
                        <button type="button" class="btn btn-dark"> <svg class="bi bi-cart-plus" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<footer class="text-center footer">
    <div class="text-center">
        <h6> Vous etes nouveau client? <a href="signin.php"> <button type="button" class="btn btn-dark"> Identifier-vous
                    <svg class="bi bi-person-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"> </path>
                        <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"> </path>
                        <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"> </path>
